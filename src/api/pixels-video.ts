...
const PEXELS_API_KEY = "GkqprWrLXNM81FeaRy6BnaxH3NjZrBaZMm2c1n3Jm6RfKn7PYp5WH1jb";
...
export async function GET(url: string) {
	...
	const perPage = params.get("per_page") || "15"; // Fewer videos per page due to larger file sizes

	const apiKey = import.meta.env.PEXELS_API_KEY || PEXELS_API_KEY;
