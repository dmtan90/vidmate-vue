...
import { DialogContent as SheetContentRadix } from 'radix-vue';
import { cn } from '@/lib/utils';
import SheetPortal from './sheet-portal.vue';
...
const props = defineProps({
  ...
  side: { type: String as PropType<"top" | "bottom" | "left" | "right">, default: 'right' },
});
...
<template>
  <SheetPortal>
    <SheetContentRadix :class="computedClass" v-bind="attrs">
      <slot />
