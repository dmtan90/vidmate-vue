...
interface IObservable<T> {
  ...
  on(eventName: "touch:longpress", handler: (e: IEvent<TouchEvent>) => void): T;
...
export class Gradient {
   ...
   */
  constructor(options: { type?: string | undefined; gradientUnits?: any; offsetX?: any; offsetY?: any; colorStops?: IGradientOptionsColorStops | undefined; coords?: IGradientOptionsCoords | undefined });
  /**
...
export class Text extends Object {
   ...
   */
  __charBounds?: Array<Array<{ width: number; left: number; height?: number | undefined; kernedWidth?: number | undefined; deltaY?: number | undefined }>> | undefined;
  /**
...
interface IUtilMisc {
   ...
   */
  composeMatrix(options: { angle: number; scaleX: number; scaleY: number; flipX: boolean; flipY: boolean; skewX: number; skewY: number; translateX: number; translateY: number }): number[];
...
interface IUtil extends IUtilImage, IUtilAnimation, IUtilArc, IObservable<IUtil>, IUtilDomEvent, IUtilDomMisc, IUtilDomRequest, IUtilDomStyle, IUtilClass, IUtilMisc {
  ease: IUtilAnimEase;
  array: IUtilArray;
  object: IUtilObject;
  string: IUtilString;
